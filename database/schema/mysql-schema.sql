...
CREATE TABLE `pengembalian` (
  ...
  `status` enum('Dikembalikan','Terlambat','Hilang') NOT NULL DEFAULT 'Dikembalikan',
...
CREATE TABLE `pengembalians` (
  ...
  `deleted_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `pengembalians_nomor_transaksi_unique` (`nomor_transaksi`),
...
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (4,'2025_06_20_150937_create_kelas_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (5,'2025_06_20_150944_create_kategori_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (6,'2025_06_20_234126_create_anggota_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (7,'2025_06_20_235955_create_buku_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (8,'2025_06_21_002933_create_peminjaman_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (9,'2025_06_22_000000_create_pengembalians_table',1);
